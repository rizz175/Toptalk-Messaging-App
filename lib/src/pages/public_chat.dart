...
class _PublicChatWidgetState extends StateMVC<PublicChatWidget> {
  ...
  List<Media> publicChatImageRes = new List<Media>();
  ...
  _sendMessage({String img = ''}) async {
    if( chatcontroller.text.length > _con.limit_letters) {
      ...
      Fluttertoast.showToast(msg: "Letters can not over than " + _con.limit_letters.toString());
    } else {
  ...
  Widget headBox() {
    return Padding(
        ...
        child: Row(
          ...
          children: [
            Text(S.of(context).public_chat_room,
...
showbottom(i, context);
    ...
    SizedBox(width: 5,),
    Text(_listMessages[i].distance == null ? "0 " : "${double.parse(_listMessages[i].distance ).toStringAsFixed(0).toString() } ${_listMessages[i].distanceUnit}",
                      ...
                      actions: <Widget>[
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text("Top", style: TextStyle(color: Colors.white, fontSize: 12),),
                          ),
                        ),
                        GestureDetector(
                       ...
                       onTap: () {
                          ...
                          child: Container(
                            ...
                            child: Text("Copy", style: TextStyle(color: Colors.white, fontSize: 12),),
                          ),
                        ),
                        GestureDetector(
                          onTap: () {
    ...
    ;},
                  ...
                  //     //     GestureDetector(
                  //     //       onTap: () {
                  //     //         if(_con.myId != _listMessages[i].senderId.toString()) {
                  ...
                  //     //               image: DecorationImage(
                  //     //                   image: Image.network(Constants.SERVER_URL + "v1/user/img-src/" + _listMessages[i].avatarUrl.toString()).image,
                  //     //                   fit: BoxFit.fill
                  //     //               )
                  //     //           ),
                  //     //         ),
                  ...
                  //                         SizedBox(
                  //                           width: 100,
                  //                           child: Text(_listMessages[i].senderName, textAlign: TextAlign.left, overflow: TextOverflow.ellipsis, maxLines: 1,
                  ...
                  GestureDetector(
                      onTap: () async {
                        ...
                        await ImagesPicker.pick(
                          ...
                          cropOpt: CropOption(
                            aspectRatio:
                            CropAspectRatio.wh3x4,
                          ),
                        );
                        setState(() {
                          if (publicImagePaths.length < 9) {
                            publicChatImageRes
                                .map((e) => publicImagePaths
                                .add(e.path))
                                .toList();
                          }
                        });
  ...
  Future<void> uploadMultiImages() async {
    ...
    for (var file in publicImagePaths) {
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text( _listMessages[i].senderName,
          style:TextStyle(color:Colors.black,fontWeight:FontWeight.bold),),SizedBox(width:10,),

                          ],
                        ),
                        SizedBox(height:10),
                        Text(_listMessages[i].email.toUpperCase()
...
SizedBox(width:15,),
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Icon(Icons.location_pin, size: 10, color: Colors.white,),
                                  SizedBox(width: 5,),
                                  Text(double.parse(_listMessages[i].distance).toStringAsFixed(0).toString() +_listMessages[i].distanceUnit  ,
                        ...
                        Row(
                          children: [
                            Text(_listMessages[i].credit + "%", textAlign: TextAlign.center,
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child:Center(child: Text("Private Chat",style:TextStyle(color:Colors.white),))
                            ,
                          ),
                        ),
                      ],

        ...
        children: [
          Column(
            ...
            children: [
              ...
              SizedBox(height: 40,),
              Text("Please Input your Verification Code.", textAlign: TextAlign.center, maxLines: 1,
      ...
      Navigator.of(context).push(MaterialPageRoute(
          builder: (_) => RetrieveNewPasswordWidget(widget.user_id)))
                ...
                child: Container(
                  ...
                  child: Text(S.of(context).next, textAlign: TextAlign.center, maxLines: 1,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(S.of(context).resend, textAlign: TextAlign.center, maxLines: 1,
                      style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Color(0xff7452A8))),
                ),
              ),
            ],
          )

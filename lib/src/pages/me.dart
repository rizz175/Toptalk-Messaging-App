    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          // SizedBox(width: 50,),
          Text(S.of(context).my_account, textAlign: TextAlign.center, maxLines: 1,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 20,),
                          Text(S.of(context).change_nickname,
                              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.black)),
                        ],
                      ),
                     GestureDetector(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(S.of(context).sign_out,
                                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xffFF1313))),
                            ],
                          ),
                        ),
                      )

    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(S.of(context).private_chat,
                                    ...
                                    Stack(
                                      children: [
                                        ...
                                        _con.rooms[i]['lastMessage']['unread_count'] > 0 && !json.decode(json.encode(_con.rooms[i]['lastMessage']['users_see_message'])).contains(_con.myID.toString())
                                            ? Padding(
                                            padding: EdgeInsets.only(left: config.App(context).appWidth(9), top: config.App(context).appWidth(0)),
                                            child: Container(
                                              padding: EdgeInsets.symmetric(horizontal: 1, vertical: 1),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Icon(Icons.circle, size: 5,),
                                                    Text(double.parse(userInfo['distance'].toString()).toStringAsFixed(0).toString() + userInfo['distance_unit'].toString(), textAlign: TextAlign.center,
                                                        style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Color(0xffAEAEAE))),
                                                    SizedBox(width: 3,),
                                                  ],
                                                ),

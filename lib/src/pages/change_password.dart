    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 50,),
          Text(S.of(context).change_password, textAlign: TextAlign.center, maxLines: 1,
          ...
          child: ListView(
            children: [
              ...
              _con.loading ? progress: GestureDetector(
                onTap: () => {
                  if(_con.oldpwController.text.length != 0 && _con.newpwController.text.length != 0 && _con.confirmnewpwController.text.length != 0 && _con.confirmnewpwController.text == _con.newpwController.text) {
                ...
                child: Container(
                  ...
                  child: Text(S.of(context).update_password, textAlign: TextAlign.center,

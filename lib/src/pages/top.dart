...
showbottom(int i,String imgurl,String sendername,String email,String credit,String distance,String unit,String gender){
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height:10),
                      Text(email.toUpperCase(),style:TextStyle(color:Colors.white),)
                    ],
                  ),
                  Column(
                    children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 5,),
                                Text(double.parse(distance).toStringAsFixed(0).toString() +unit  ,
    ...
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          Text(S.of(context).top.toUpperCase(), textAlign: TextAlign.center, maxLines: 1,

    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 50,),
          Text(S.of(context).registration_login, textAlign: TextAlign.center, maxLines: 1,
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Center(child: Text("Pick Account Number", style: TextStyle(color: Color(0xff959595), fontSize: 20),)),
              SizedBox(
                height: 20,
              ),
...
log(indexx.toString());
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("more...", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),)),
                        ),
                      );
                    }
                  else{
...
log(_con.assignednumber.toString());
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(width:2,color:tapped==index ?Colors.deepPurple:Colors.transparent),
                            color:listofnumbers[index].isAssigned==false ? Colors.green.shade200:Colors.grey),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText: "  " + S.of(context).password + " (≥8 characters)",
                    hintStyle: TextStyle(color: Color(0xff959595), fontSize: 18, fontWeight: FontWeight.w400),
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.grey),
                      //  when the TextFormField in unfocused
              ...
              SizedBox(height: 50,),
              Text("Please screenshot to record your account and password." , style: TextStyle(color: Colors.grey, fontSize: 11 , fontWeight: FontWeight.w400),),
              SizedBox(height: 10,),
              Container(
                    ...
                    if( _con.passwordController.text.length >= 8)
                    ...
                    else
                      {
                        showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                title: Text("Password Failure'(密码错误)"),
                                actions: <Widget>[
                                  TextButton(
                                      onPressed: () {
                                        Navigator.pop(context);
    ...
    child: Text('close'))
                ...
                child: Container(
                  ...
                  child: Text(S.of(context).finish_register, textAlign: TextAlign.center, maxLines: 1,

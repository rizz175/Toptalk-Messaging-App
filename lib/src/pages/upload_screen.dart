            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Enter Text Here ( max. 1000 words )',
              ...
              Padding(
                ...
                child: Text("Add Photos ( max.9)",
                    style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xffACACAC))),
              ),
              SizedBox(height: 20,),
              Container(
                width: config.App(context).appWidth(100),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Add Photos",
                        style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xff7452A8))),

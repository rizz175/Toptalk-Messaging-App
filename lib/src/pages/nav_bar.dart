                  ...
                  child:  SalomonBottomBar(
                    ...
                    items: [
                      ...
                      SalomonBottomBarItem(
                          ...
                          title: Text(S.of(context).public_chat, style: TextStyle(color: Color(0xff7452A8), fontSize: 10)),
                      ...
                      SalomonBottomBarItem(
                          ...
                          title: Text(S.of(context).top.toUpperCase(), style: TextStyle(color: Color(0xff7452A8), fontSize: 10)),
                          selectedColor: Color(0xff7452A8),
                          unselectedColor: Color(0xff7452A8)
                      ),
                      SalomonBottomBarItem(
                          icon: ImageIcon(AssetImage('assets/img/tab4.png'), size: 24,),
                          title: Text(S.of(context).private_chat, style: TextStyle(color: Color(0xff7452A8), fontSize: 10)),
                          selectedColor: Color(0xff7452A8),
                          unselectedColor: Color(0xff7452A8)
                      ),
                      SalomonBottomBarItem(
                          icon: ImageIcon(AssetImage('assets/img/tab5.png'), size: 24,),
                          title: Text(S.of(context).me, style: TextStyle(color: Color(0xff7452A8), fontSize: 10)),
                          selectedColor: Color(0xff7452A8),
                          unselectedColor: Color(0xff7452A8)
                      ),
                    ],

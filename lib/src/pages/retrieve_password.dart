    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 50,),
          Text(S.of(context).retrieve_password, textAlign: TextAlign.center, maxLines: 1,
        ...
        children: [
          Column(
            ...
            children: [
              ...
              SizedBox(height: 40,),
              Text("Please Input your Email.", textAlign: TextAlign.center, maxLines: 1,
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xff7452A8).withOpacity(0.5))),
              SizedBox(
                width: config.App(context).appWidth(60),
                child: Text("APP will send you an emailto this email address. After you recieve the email, click the link in the email and enter your new password in a newly opened web page", textAlign: TextAlign.start,
                    style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xff7452A8).withOpacity(0.5))),
              ),
              SizedBox(height: 200,),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(S.of(context).send, textAlign: TextAlign.center, maxLines: 1,

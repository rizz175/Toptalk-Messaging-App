...
_con.sendnotif(chatcontroller.text.trim(),"You have a new message",_con.partnerInfo['deviceToken']);
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (_) {
                                      return DetailScreen(url: Constants.SERVER_URL+ "v1/message/img-src/" + (_con.listMessages[index].imgs as List)[0].toString());
                                    }));
                                  },
                                  child: Image.network(Constants.SERVER_URL+ "v1/message/img-src/" + (_con.listMessages[index].imgs as List)[0].toString(), width: config.App(context).appWidth(60), fit: BoxFit.fitWidth,),
                                ),
                              Padding(
  ...
  Future<void> uploadMultiImages() async {
    ...
    for (var file in privateImagePaths) {
